...
from watchmen.api.__route import ROUTER as router_info

from watchmen.app_config import \
...
# Deployment Note:
# PYTHONPATH=. gunicorn -c ouroboros/config_uvicorn.py watchmen.app_fastapi:app
app = fastapi.FastAPI(
    title=api_name,
