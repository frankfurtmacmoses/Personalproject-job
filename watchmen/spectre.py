...
SNS_TOPIC_ARN = "arn:aws:sns:us-east-1:405093580753:HancockTest"

#Message Strings
SUCCESS_MESSAGE = "Georgia Tech Feed data found on S3! File found: "
FAILURE_MESSAGE = "could not be found in hancock/georgia_tech! Please check S3 and Georgia Tech VM!"
FAIL_SUBJECT_MESSAGE = "Spectre georgia_tech data monitor detected a failure!"
