...
OZYMANDIAS = {
    "reflection_exception_message": "The following exception have been detected in",
    "exception_detected_subject": "Cannot make API call to Dremio  check the logs for details!",
    "reflection_failed_message": "One or more reflection refresh has failled: as shown in the message body {}!",
    "reflection_failled_subject": "One or more reflection refresh has failled",
    "reflection_success_message": "All reflections are refreshed {} Updated!",
    "reflection_success_subject": "All reflections are refreshed",
    "reflectiton_success_detail" : "All reflections passed the test. There was no exception, reflections can accellerate queries"
}
RORSCHACH = {
