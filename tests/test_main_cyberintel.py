"""
# test_main_cyberintel
"""
import unittest
from mock import patch
from watchmen import const, main_cyberintel
...
class MainRorschachTester(unittest.TestCase):
    ...
    def test_start_rorschach_watcher(self, mock_alert, mock_save, mock_monitor, mock_rorschach):
        ...
        returned = main_cyberintel.start_rorschach_watcher({}, None)
