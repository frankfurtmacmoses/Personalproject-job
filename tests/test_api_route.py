...
from watchmen.api.__route import \
    api_icon, \
    api_info, api_root, \
    api_v1_redirect, \
    get_info
...
class ApiRouteTester(unittest.TestCase):
    """
    ApiRouteTester includes all unit tests for watchmen.api.__route module
    """
    ...
    @mock.patch('watchmen.api.__route.RedirectResponse')
