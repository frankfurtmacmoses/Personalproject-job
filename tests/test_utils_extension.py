...
from watchmen.utils.extension import get_module
from watchmen.utils.extension import is_function
from watchmen.utils.extension import pickle_object
from watchmen.utils.extension import pickle_to_str
...
class ExtensionTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.proj_path = os.path.join(self.repo_path, "watchmen")
    ...
    def test_check_duplicate_key(self):
        """
        test watchmen.utils.extension.check_duplicate_key
        """
        tests = [
            {
    ...
    def test_check_valid_md5(self):
        """
        test watchmen.utils.extension.check_valid_md5
        """
        tests = [
    ...
    def test_get_attr_from_object(self):
        """
        test watchmen.utils.extension.get_attr (object)
        """
        tests = [
    ...
    def test_get_camel_title_word(self):
        """
        test watchmen.utils.extension.get_camel_title_word
        """
        tests = [
    ...
    def test_get_class(self):
        """
        test watchmen.utils.extension.get_class
        """
        tests = [
            {
    ...
    def test_get_hash(self):
        """
        test watchmen.utils.extension.get_hash
        """
    ...
    def test_get_hash_from_file(self):
        """
        test watchmen.utils.extension.get_hash from file
        """
    ...
    def test_get_hash_from_large_file(self):
        """
        test watchmen.utils.extension.get_hash from large file
        """
    ...
    def test_get_hash_on_exception(self):
        """
        test watchmen.utils.extension.get_hash on exception
        """
        orig_func = os.path.getsize
    ...
    def test_pickle_to_str(self):
        """
        test watchmen.utils.extension.pickle_to_str
        """
