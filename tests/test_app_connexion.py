...
from watchmen.app_connexion import \
    app_main, \
    config_connexion, \
    check_cert, \
...
class AppTester(unittest.TestCase):
    """
    AppTester includes all unit tests for watchmen.app_connexion module
    """
    ...
    @patch('watchmen.app_connexion.app')
    ...
    def test_main_module(self, mock_main):
        # import runpy
        # runpy.run_module('watchmen.app_connexion', run_name='__main__')
        pass

    @patch('watchmen.app_connexion.os')
    @patch('watchmen.app_connexion.app')
    @patch('watchmen.app_connexion.get_boolean')
    def test_check_cert(self, mock_get, mock_app, mock_os):
        from watchmen.app_connexion import SSL_CONTEXT
        tests = [{
    ...
    @patch('watchmen.app_connexion.request')
    @patch('watchmen.app_connexion.redirect')
    ...
    def test_root_api_v1(self, mock_redirect, mock_request):
        ...
        mock_request.host_url = 'https://127.0.0.1:8080/'
        mock_request.url = 'https://127.0.0.1:8080/api/v1/' + mock_rest_path
