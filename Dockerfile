...
MAINTAINER Cyber Intel kramos@infoblox.com
LABEL maintainer="kramos@infoblox.com"
LABEL organization="infobloxcto"
LABEL project="Watchmen Project"
...
ENV PROJECT=cyberint-watchmen \
    PROJECT_DIR=watchmen \
    SHELL=/bin/bash \
    SOURCE=/src
